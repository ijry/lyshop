<template>
  <div @click="$router.push(`/product/${product.id}`)"
    class="group bg-white rounded-xl border border-gray-100 overflow-hidden cursor-pointer hover:shadow-lg hover:border-gray-200 hover:-translate-y-1 transition-all duration-300">
