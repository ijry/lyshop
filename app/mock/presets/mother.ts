...
export const mother: MockPreset = {
    ...
    list: [
      {
        ...
        cover: 'https://picsum.photos/400/400?random=700',
      ...
      },
      {
        ...
        cover: 'https://picsum.photos/400/400?random=702',
  ...
  productDetail: {
    ...
    cover: 'https://picsum.photos/750/750?random=700',
    price: 298.00,
    origin_price: 368.00,
    stock: 800,
    sales: 6520,
    ...
    detail: {
      ...
      blocks: [
        ...
        },
        {
          ...
          type: 'image',
          props: {
            url: 'https://picsum.photos/750/420?random=708',
            alt: '奶粉营养成分展示',
          },
        },
        {
    ...
    images: [
      { id: 601, product_id: 601, url: 'https://picsum.photos/750/750?random=700', sort: 0 },
      { id: 602, product_id: 601, url: 'https://picsum.photos/750/750?random=701', sort: 1 },
      { id: 603, product_id: 601, url: 'https://picsum.photos/750/750?random=702', sort: 2 },
      { id: 604, product_id: 601, url: 'https://picsum.photos/750/750?random=703', sort: 3 },
    ],
  },
    ...
    components: [
      {
        ...
        props: {
          images: [
            { url: 'https://picsum.photos/750/340?random=700', link: '/pages/product/list?category_id=601' },
            { url: 'https://picsum.photos/750/340?random=701', link: '/pages/marketing/coupon?mode=claim' },
            { url: 'https://picsum.photos/750/340?random=702', link: '/pages/product/list?category_id=603' },
          ],
          height: 340,
        },
      },
    ...
    list: [
      {
        ...
        products: [
          { product_id: 602, title: '花王妙而舒纸尿裤L码', cover: 'https://picsum.photos/400/400?random=701', origin_price: 129, activity_price: 89, activity_stock: 200 },
          { product_id: 605, title: '纯棉婴儿连体衣', cover: 'https://picsum.photos/400/400?random=704', origin_price: 49.90, activity_price: 29.90, activity_stock: 150 },
          { product_id: 603, title: '费雪益智积木80粒', cover: 'https://picsum.photos/400/400?random=702', origin_price: 89, activity_price: 59, activity_stock: 80 },
        ],
      },
    ],
    ...
    list: [
      {
        ...
        products: [
          { product_id: 601, title: '爱他美卓萃3段奶粉900g', cover: 'https://picsum.photos/400/400?random=700', origin_price: 298, group_price: 248, group_stock: 100 },
          { product_id: 607, title: '小白熊辅食机', cover: 'https://picsum.photos/400/400?random=706', origin_price: 259, group_price: 199, group_stock: 50 },
          { product_id: 606, title: '基诺浦学步鞋', cover: 'https://picsum.photos/400/400?random=705', origin_price: 169, group_price: 139, group_stock: 60 },
        ],
      },
    ],
  },
    ...
    list: [
      {
        ...
        start_at: '2026-05-01T00:00:00Z', end_at: '2026-07-01T23:59:59Z', status: 1,
        products: [
          { product_id: 603, title: '费雪益智积木80粒', cover: 'https://picsum.photos/400/400?random=702', origin_price: 89, floor_price: 0.01, max_helpers: 15, current_helpers: 7 },
          { product_id: 605, title: '纯棉婴儿连体衣', cover: 'https://picsum.photos/400/400?random=704', origin_price: 49.90, floor_price: 5, max_helpers: 10, current_helpers: 3 },
        ],
      },
    ],
  },
  ...
  recommend: [
    { product_id: 601, title: '爱他美卓萃3段奶粉900g', cover: 'https://picsum.photos/400/400?random=700', price: 298, origin_price: 368, sales: 6520 },
    { product_id: 602, title: '花王妙而舒纸尿裤L码', cover: 'https://picsum.photos/400/400?random=701', price: 129, origin_price: 168, sales: 12800 },
    { product_id: 606, title: '基诺浦学步鞋', cover: 'https://picsum.photos/400/400?random=705', price: 169, origin_price: 228, sales: 2890 },
    { product_id: 607, title: '小白熊辅食机', cover: 'https://picsum.photos/400/400?random=706', price: 259, origin_price: 358, sales: 1560 },
  ],
  ...
  cart: [
    {
      ...
      qty: 2,
      product: {
        id: 601, title: '爱他美卓萃3段奶粉900g', cover: 'https://picsum.photos/200/200?random=700', price: 298.00,
      },
      sku: {
    ...
    },
    {
      ...
      qty: 1,
      product: {
        id: 602, title: '花王妙而舒纸尿裤L码', cover: 'https://picsum.photos/200/200?random=701', price: 129.00,
      },
      sku: {
    ...
    list: [
      {
        ...
        items: [
          {
            id: 6011, product_id: 601, title: '爱他美卓萃3段奶粉900g', cover: 'https://picsum.photos/200/200?random=700', qty: 1, price: 298.00,
            review: {
          ...
          {
            id: 6012, product_id: 602, title: '花王妙而舒纸尿裤L码', cover: 'https://picsum.photos/200/200?random=701', qty: 1, price: 129.00,
          },
        ],
      ...
      },
      {
        ...
        items: [
          {
            id: 6021, product_id: 603, title: '费雪益智积木80粒', cover: 'https://picsum.photos/200/200?random=702', qty: 1, price: 89.00,
            review: {
          ...
          {
            id: 6022, product_id: 607, title: '小白熊辅食机', cover: 'https://picsum.photos/200/200?random=706', qty: 1, price: 259.00,
          },
        ],
      ...
      },
      {
        ...
        items: [
          {
            id: 6031, product_id: 608, title: '好孩子轻便婴儿推车', cover: 'https://picsum.photos/200/200?random=707', qty: 1, price: 599.00,
          },
        ],
      ...
      },
      {
        ...
        items: [
          {
            id: 6041, product_id: 603, title: '费雪益智积木80粒', cover: 'https://picsum.photos/200/200?random=702', qty: 1, price: 89.00,
          },
        ],
