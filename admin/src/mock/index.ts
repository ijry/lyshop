...
const routes: Record<string, any> = {
  ...
  'GET /admin/api/im/sessions': [
    { id: 1, user_id: 1001, user_nickname: '张三', user_avatar: 'https://picsum.photos/80/80?random=u1', staff_id: 1, status: 2, queue_position: 0, last_msg: '这款耳机降噪效果怎么样？', unread_count: 1, updated_at: '2026-05-28T10:30:00Z' },
    { id: 2, user_id: 1002, user_nickname: '李四', user_avatar: 'https://picsum.photos/80/80?random=u2', staff_id: 0, status: 1, queue_position: 1, last_msg: '你好，我想退货，订单号 10003', unread_count: 3, updated_at: '2026-05-28T09:15:00Z' },
    { id: 3, user_id: 1003, user_nickname: '王五', user_avatar: 'https://picsum.photos/80/80?random=u3', staff_id: 1, status: 2, queue_position: 0, last_msg: '物流显示已签收但我没收到', unread_count: 0, updated_at: '2026-05-27T18:42:00Z' },
    { id: 4, user_id: 1004, user_nickname: '赵六', user_avatar: 'https://picsum.photos/80/80?random=u4', staff_id: 1, status: 3, queue_position: 0, last_msg: '好的，感谢解答', unread_count: 0, updated_at: '2026-05-27T14:20:00Z' },
    { id: 5, user_id: 1005, user_nickname: '陈七', user_avatar: 'https://picsum.photos/80/80?random=u5', staff_id: 0, status: 1, queue_position: 2, last_msg: '请问有没有大号的？', unread_count: 1, updated_at: '2026-05-28T11:05:00Z' },
    { id: 6, user_id: 1006, user_nickname: '何八', user_avatar: 'https://picsum.photos/80/80?random=u6', staff_id: 1, status: 2, queue_position: 0, last_msg: '发票什么时候能开好？', unread_count: 2, updated_at: '2026-05-28T08:50:00Z' },
    { id: 7, user_id: 1007, user_nickname: '孙九', user_avatar: 'https://picsum.photos/80/80?random=u7', staff_id: 0, status: 1, queue_position: 3, last_msg: '这个颜色和图片上差别大吗', unread_count: 1, updated_at: '2026-05-28T07:30:00Z' },
  ],
