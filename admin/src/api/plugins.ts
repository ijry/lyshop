...
export const getSpecTemplates = (params?: any) => request.get('/spec-templates', { params })
export const getStocksBySkuIds = (skuIds: number[]) => request.get('/wms/stocks/by-skus', { params: { sku_ids: skuIds.join(',') } })
export const getSpecTemplate = (id: number) => request.get(`/spec-templates/${id}`)
export const createSpecTemplate = (data: any) => request.post('/spec-templates', data)
export const updateSpecTemplate = (id: number, data: any) => request.put(`/spec-templates/${id}`, data)
export const deleteSpecTemplate = (id: number) => request.delete(`/spec-templates/${id}`)
