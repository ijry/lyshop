<template>
  <div class="space-y-4">
    <div>
      <label class="block text-xs text-slate-500 mb-1.5">标题（可选）</label>
    ...
    <div>
      <label class="block text-xs text-slate-500 mb-1.5">显示数量</label>
